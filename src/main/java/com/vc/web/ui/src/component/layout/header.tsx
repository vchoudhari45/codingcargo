...
const Header: React.FC = props => {
    ...
    const menuCss = "rounded-md text-gray-500 hover:bg-gray-800 hover:text-white md:hover:bg-gray-900 mt-1 px-2 py-2 md:mt-0 md:px-0 md:py-0 block md:inline-block md:ml-3 md:mr-3"
