...
Error.getInitialProps = ({ res, err }) => {
	...
	const contentMessage = statusCode == 404 ? "<p>We apologize for the inconvenience, we can’t find the page you were looking for.</p><p><a href='https://www.codingcargo.com/' class='absolute'>Go to homepage</a></p>" : "<p>We apologize for the inconvenience, Something is broken.</p><p><a href='https://www.codingcargo.com/' class='absolute'>Go to homepage</a></p>"
	return { 
