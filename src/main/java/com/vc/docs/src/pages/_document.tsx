...
nERDtQAAAABJRU5ErkJggg==" rel="icon" type="image/x-icon" />
					...
					<meta httpEquiv="Content-Security-Policy" content="script-src 'self' *.googlesyndication.com; default-src 'self' *.google-analytics.com; img-src 'self' *.google-analytics.com upload.wikimedia.org data:" />
