...
nERDtQAAAABJRU5ErkJggg==" rel="icon" type="image/x-icon" />
					...
					<meta httpEquiv="Content-Security-Policy" content="default-src 'self' *.google-analytics.com; script-src 'self' *.googlesyndication.com; img-src 'self' *.google-analytics.com upload.wikimedia.org data:" />
