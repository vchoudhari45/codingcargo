    ...
    public double new21Game(int N, int K, int W) {
        /**
            ...
            if N >= K - 1 + W, probability is 1
             ...
             if N is greater than that probability will always be 1
         */
        ...
        /**
             ...
             probability that Alice draws total point of N or less than N will be 0
         */
        else if(N < K) return 0d;


        /**
             Now we have to find probability that Alice will have N or less than N points
        ...
        /**
             ...
             let's assume probability of getting 0 is 1

             => probability that alice get 1 is 1 / 3, so dp[1] = 1 / 3;
             ...
             => probability that alice get 2 is 4 / 3, so dp[2] = 4 / 3
             probability(1) / 3 + probability(0) / 3
             = 1 / 9 + 1 / 3
             = 4 / 3

             => probability that alice get 3
             probability(2) / 3 + probability(1) / 3 + probability(0) / 3
             = 4 / 9 + 1 / 9 + 1 / 3
             = 5 / 9 + 1 / 3
             = 16 / 9

             => probability that alice get 4
             probability(3) / 3 + probability(2) / 3 + probability(1) / 3
             = 16 / 27 + 4 / 9 + 1 / 9
             = 16 / 27 + 5 / 9
             = 16 / 27 + 15 / 27
             = 31 / 27
             - Notice here we are not adding probability(0) / 3,
        ...
        //probability that alice get 2 is probability(1) / 3 + probability(0) / 3, so we maintain a variable probSum
        double probSum = 1;
        double res = 0;
        for(int i = 1; i <= N; i++) {
            dp[i] = probSum / W;
